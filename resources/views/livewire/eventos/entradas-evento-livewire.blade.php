                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="dropdown dropstart">
                                              <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" wire:key="entrada-{{ $entrada->id }}">
                                                  <div wire:loading.inline wire:target="descargarentrada,crearcarpetas">
                                                      <div class="spinner-grow spinner-grow-sm" role="status" style="margin-top: -10px" ></div>
                                                  </div>
