            ...
            <div class="row justify-content-md-center">
                <div class="col-md-12 col-lg-4">
                    <div class="authent-logo">
                        ...
                        <p class="text-white">Bienvenidos a <span class="font-weight-bold">{{\App\Models\Setting::find(1)->app_name}}</span></p>
                    </div>
                    <div class="card login-box-container">
                        <div class="card-body">
                            <form method="POST" action="{{ route('iniciar.post') }}" class="needs-validation " novalidate="">
                                @csrf
                                <div class="d-block">
                                ...
                                <div class="d-flex mb-3">
                                    <div class="col-md-4 col-4 " >
                                        <select class="form-select @error('prefijo') is-invalid @enderror" id="prefijo" name="prefijo" required value="{{ old('prefijo') }}">
                                ...
                                <div class="mb-3 form-check">
                                  <input type="checkbox" class="form-check-input"  name="remember"  tabindex="3" id="remember" value="{{ old('remember') }}">
                        ...
                        @csrf
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox"  name="remember" class="custom-control-input" tabindex="3" id="remember" value="{{ old('remember') }}">
